...
import { ClaudeSDKIntegration, PiMonoIntegration, OpenCodeSDKIntegration, OpenClawIntegration, } from '../src/integrations';
...
describe('SDK Integrations', () => {
    ...
    describe('PiMonoIntegration', () => {
        ...
        it('should trigger workflows', async () => {
            // Should not throw
            await expect(piMono.triggerWorkflow('test-workflow', { data: 'test' })).resolves.toBeUndefined();
        });
